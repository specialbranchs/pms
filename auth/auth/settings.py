...
ALLOWED_HOSTS = ['pms.specialbranch.gov.bd','localhost','127.0.0.1','118.179.167.202']
...
CSRF_TRUSTED_ORIGINS = ['https://pms.specialbranch.gov.bd']
...
SIMPLE_JWT = {
    "ACCESS_TOKEN_LIFETIME": timedelta(minutes=14*60),
    ...
    "SLIDING_TOKEN_LIFETIME": timedelta(minutes=14*60),
